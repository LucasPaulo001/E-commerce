            ...
            >
              <div className="flex flex-col w-full justify-center items-center">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-2xl">{l.product.name}</span>
                  <p>{l.product.description}</p>
                </div>
              </div>
              <div className="flex flex-col md:flex-row justify-center items-center gap-3.5">
                <span className="font-bold">R${l.product.price}</span>
                ...
                <div className="flex gap-3 items-center">
                  <Button
                    ...
                    onClick={() =>
                      setQuantity((prev) => ({
                        ...prev,
                        [l.id]: Math.max((prev[l.product.id] || 0) - 1, 0),
                      }))
                    }
                  >
                    -
                  ...
                  <span className="text-2xl">{quantity[l.product.id] || 0}</span>
                  ...
                  <Button
                    onClick={() => handleRemove(l.product.id)}
                    variant={"destructive"}
                  >
                    <Trash />
                  </Button>
